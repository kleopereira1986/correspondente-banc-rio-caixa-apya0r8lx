                    ...
                    return (
                      <div key={msg.id} className={`flex gap-3 ${isMe ? 'flex-row-reverse' : ''}`}>
                        ...
                        >
                          ...
                          <div
                            className={`px-4 py-2 rounded-2xl text-sm whitespace-pre-wrap ${isMe ? 'bg-primary text-primary-foreground rounded-tr-none' : 'bg-white border border-slate-200 text-slate-800 rounded-tl-none shadow-sm'}`}
                          >
                            {msg.message}
                          </div>
